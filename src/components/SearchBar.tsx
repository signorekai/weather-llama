		...
		<>
			<div
				...
				<form className="relative" onSubmit={handleSubmit}>
					<input
						className={`bg-white text-black dark:bg-blue-mid dark:text-white shadow-md outline-offset-1 rounded-lg px-4.5 py-2 lg:px-4 lg:py-1 default-transition hover:px-4.5 hover:py-2 focus:px-4.5 focus:py-2 w-full md:min-w-96 ${
					...
					<AnimatePresence mode="wait">
						{isFetching && (
							<motion.div
								...
								animate={{ opacity: 1 }}
								exit={{ opacity: 0 }}
								className="w-5 h-5 text-black dark:text-white opacity-50  absolute right-3 top-1/2 -translate-y-1/2">
								<svg
